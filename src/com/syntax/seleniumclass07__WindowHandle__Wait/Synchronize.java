...
/*
 * /*
 * public class SynchronizationExplanation extends MyBase{
	...
	â—? pageLoadTimeout	--> to prevent TimeOutException exception
	...
	There are two types of wait Selenium provides
		...
		â—? ExplicitWait--->all dynamic element loading longer time
			-	WebdriverWait
			...
			-	FluentWait
				...
				which to check the condition before throwing an â€œElementNotVisibleExceptionâ€? exception.
